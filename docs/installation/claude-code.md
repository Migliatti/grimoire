...
3. Choose a verified Claude Code scope from the table above.
...
5. In Claude Code, verify discovery through the skill list or invoke the chain entrypoint as `/business-direction`.
